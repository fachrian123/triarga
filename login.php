...
<body class="bg-danger">
    <div class="container ">
        ...
        <div class="card mx-auto mt-5" style="width: 400px;">
            <div class="card-body">
                <h2 class="card-title mt-3">Masuk</h2>
                <h6 class="card-subtitle mb-2 float-end">
                    <a href="daftar.php" class="text-danger" style="text-decoration: none;">Daftar</a>
                </h6>
                <form action="mesin/proses_login.php" method="post">
                    <div class="mb-3 mt-4">
                    ...
                    <a href="#" class="float-end text-danger" style="text-decoration: none;" data-bs-toggle="modal"
                        data-bs-target="#exampleModal">Lupa password ?</a>
